...
if($validando->num_rows > 0){
    ...
    $insertar = "INSERT INTO empleados (nombre,apellido1,apellido2,correo,contra)VALUES('$nombre','$apellido1','$apellido2','$correo','$contra');";
