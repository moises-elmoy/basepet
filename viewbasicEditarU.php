...
$id = $_GET['idcliente'];
$m = "SELECT * FROM clientes WHERE idcliente = '$id'";
...
$nombre = $conecta->real_escape_string($_POST['eNombre']);
$apellido1 = $conecta->real_escape_string($_POST['eApellido1']);
$apellido2 = $conecta->real_escape_string($_POST['eApellido2']);
$correo = $conecta->real_escape_string($_POST['eCorreo']);
$pass = $conecta->real_escape_string(md5($_POST['eContra']));
$telefono = $conecta->real_escape_string($_POST['eTelefono']);
$direccion = $conecta->real_escape_string($_POST['eDireccion']);
$colonia = $conecta->real_escape_string($_POST['eColonia']);
...
<body style="background-color: #A3D2CA;">
    <div class="container-fluid shadow p-3 w-50 h-60 mt-5" style="background-color: lightgray;">
        <div class="col-sm-12 col-md-12 col-lg-12">
            <h3 class="text-center">Editar Perfíl</h3>
            <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="POST">
                <div class="row mt-4">
                    ...
                    <input type="text" name="eNombre" class="form-control" value="<?php echo $datos['nombre_cliente'];?>" require>
                </div>
                <div class="row mt-3">
                ...
                <div class="row mt-3">
                    <input type="password" name="eContra" class="form-control" value="<?php echo $datos['pass'];?>" require>
                </div>
                <div class="row mt-3">
                    <input type="number" name="eTelefono" class="form-control" max="99999999999" value="<?php echo $datos['telefono'];?>" require>
                </div>
                <div class="row mt-3">
                    <input type="text" name="eDireccion" class="form-control" value="<?php echo $datos['direccion'];?>" require>
                </div>
                <div class="row mt-3">
                    <input type="text" name="eColonia" class="form-control" value="<?php echo $datos['colonia'];?>" require>
                </div>

                    <a class="btn btn-danger mt-5 mb-3 me-2" href="viewbasicPerfil.php" role="button" style="margin-left:70%;">Cancelar</a>
